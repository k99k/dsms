...
//	}
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		byte[] preSharedKey256 = "ACME-1234ACME-1234ACME-1234".getBytes("ascii");

		try {
			String enc = encText(s, preSharedKey256, ivk);
			System.out.println(enc);
			String dec = decText(enc, preSharedKey256, ivk);
			System.out.println(dec);

			// if key and iv is same, use AesInstance for better performance
